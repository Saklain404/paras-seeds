...
import Vardhan from "./assets/img/Vardhan.jpg";
import Rani from "./assets/img/Rani.jpg";
import Suri from "./assets/img/Suri.jpg";
import Chamatkar from "./assets/img/Chamatkar.jpg";
import Maharaja from "./assets/img/Maharaja.jpg";
import Laxmi from "./assets/img/Laxmi.jpg";
import Riya from "./assets/img/Riya.jpg";
import Ananya from "./assets/img/Ananya.jpg";
import Gautam from "./assets/img/Gautam.jpg";
import Avtar from "./assets/img/Avtar.jpg";
import DhariKing from "./assets/img/DhariKing.jpg";
import Paras6242 from "./assets/img/Paras6242.jpg";
import Paras1057 from "./assets/img/Paras1057.jpg";
